...
These were taken on the complicated electricity dataset. On the nicer artificial dataset the timing looks like this:
![Graph comparing timing of jaxlogit and xlogit](https://github.com/outerl/jaxlogit/blob/main/examples/graphs/fit_estimation_time_artificial.png?raw=true)